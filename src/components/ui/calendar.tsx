  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday: cn(
          "text-muted-foreground flex h-9 w-9 items-center justify-center select-none rounded-md text-[0.8rem] font-normal",
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "h-9 w-9 p-0 font-normal cursor-pointer aria-selected:opacity-100",
